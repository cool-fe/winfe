        ...
        <div class="scroll-content">
            <div class="query-item">
                ...
                <div class="query-item-right">
                                <span :class="{'query-item-cell': true, 'is-active': i===inpatientStatus.activeIndex}"
            ...
            <div v-show="inpatStatusSubItem.list" class="query-item sub">
                ...
                <div class="query-item-right">
                    <span :class="{'query-item-cell': true, 'is-active': i===inpatStatusSubItem.activeIndex}"
                          @click="handleQueryItem(inpatStatusSubItem, cell, '', i)"
                          v-for="(cell, i) in inpatStatusSubItem.list"
                          :key="i">{{cell.label}}</span>
                    <span v-show="inpatientStatus.activeIndex===2 || inpatientStatus.activeIndex===3"
                          class="details-date">
                        指定起止日期
                        <el-date-picker
            ...
            <div v-show="inpatientStatus.activeIndex===0" class="query-item"
            ...
            <div v-show="inpatientStatus.activeIndex===0" v-for="item in queryList"
                ...
                <div class="query-item-right">
                    <span class="query-item-cell"
                          :class="{'query-item-cell': true, 'is-active': (item.activeIndex===''||item.activeIndex===undifined)}"
...
import { reqQueryCondition } from '../../../src/api/req'
